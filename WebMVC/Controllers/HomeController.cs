...
namespace WebMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult AddPedidos(int id = 0)
        {
            return View(new Models.PedidoMVC());
        }

        [HttpPost]
        public ActionResult AddPedidos(Models.PedidoMVC Pedido)
        {
        ...
        public ActionResult EditarOsPedidos(int id = 0)
        {
        ...
        [HttpPost]
        public ActionResult EditarOsPedidos(Models.PedidoMVC Pedido)
        {
